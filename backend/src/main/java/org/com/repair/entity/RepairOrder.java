...
public class RepairOrder {
    ...
    @ManyToMany
    @JoinTable(
        name = "order_rejected_technicians", 
        joinColumns = @JoinColumn(name = "order_id"),
        inverseJoinColumns = @JoinColumn(name = "technician_id")
    )
    private Set<Technician> rejectedTechnicians = new HashSet<>();
    ...
    public Set<Technician> getRejectedTechnicians() {
        return rejectedTechnicians;
    }

    public void setRejectedTechnicians(Set<Technician> rejectedTechnicians) {
        this.rejectedTechnicians = rejectedTechnicians;
    }

    public void addRejectedTechnician(Technician technician) {
        if (this.rejectedTechnicians == null) {
            this.rejectedTechnicians = new HashSet<>();
        }
        this.rejectedTechnicians.add(technician);
    }
    ...
    public Date getLastUrgedAt() {
        return lastUrgedAt;
    }

    public void setLastUrgedAt(Date lastUrgedAt) {
        this.lastUrgedAt = lastUrgedAt;
    }
